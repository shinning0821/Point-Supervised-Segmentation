...
class FPNDecoder(nn.Module):
    ...
    def forward(self, *features):
        ...
        # print(torch.unique(c2,return_counts=True)[1][0])
        # print(torch.unique(c3,return_counts=True)[1][0])
        # print(torch.unique(c4,return_counts=True)[1][0])
        # print(torch.unique(c5,return_counts=True)[1][0])
        p5 = self.p5(c5)
        p4 = self.p4(p5, c4)
        p3 = self.p3(p4, c3)
        p2 = self.p2(p3, c2)
